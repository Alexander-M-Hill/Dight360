# This program takes the website retrieved by webscrapeESPN and extracts data with regex
...
with open('espn_final.txt', 'w') as final_espn:
	print(result1, file=final_espn)
        
with open('espn_final.txt', 'a') as final_espn:
